  ...
  var express = require('express'),
    ...
    function insert_entries (req, res, next) {
      ...
      function push_entries() {
        ...
        if (incoming.length && env.pushover_api_token && env.pushover_user_key) {
          console.log(env.pushover_api_token);
          ...
          var msg = {
            ...
            message: "Glucose level of " + incoming[0].sgv + " has just been logged.",
            title: "Glucose level warning",
            sound: 'persistent',
            timestamp: incoming[0].date,
            priority: 2,
            retry: 30
          };
